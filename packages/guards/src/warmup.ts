...
const PHASE_CAPS: Record<WarmUpPhase, Partial<Record<ActionType, number>>> = {
  MANUAL: { connection: 0, message: 0, profileView: 0, searchPage: 0 },
  WEEK2: { connection: 5, message: 0, profileView: 20, searchPage: 5 },
  WEEK3: { connection: 10, message: 5, profileView: 40, searchPage: 8 },
  WEEK4: { connection: 12, message: 20, profileView: 50, searchPage: 9 },
  FULL: { connection: 15, message: 40, profileView: 60, searchPage: 10 },
};
